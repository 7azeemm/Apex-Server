...
) -> Result<Json<PriceResp>, StatusCode> {
...
pub async fn get_auction_by_auction_id(
    Path(auction_id): Path<String>,
) -> Result<Json<AuctionItemResponse>, StatusCode> {
...
pub async fn get_auctions_by_auctioneer(
    Path(auctioneer_id): Path<String>,
) -> Result<Json<Vec<AuctioneerAuctionItem>>, StatusCode> {
