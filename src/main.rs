...
use crate::player_data::player_data_tools::{get_dungeons_info, get_events_info, get_fishing_info, get_foraging_info, get_garden_info, get_inventory, get_mining_info, get_misc_info, get_player_overview, get_profile_networth, get_slayer_info};
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    // get_item(&mut pdr, "Infernal Crimson chestpalte", false).await;
    // println!("{}", pdr.get_resp().unwrap_or("No Text".to_owned()));
    //
    // get_item(&mut pdr, "Infernal Crimson helmet", false).await;
    // println!("{}", pdr.get_resp().unwrap_or("No Text".to_owned()));
    //
    // get_item(&mut pdr, "Infernal terror leggigns", false).await;
    // println!("{}", pdr.get_resp().unwrap_or("No Text".to_owned()));
    //
    // get_item(&mut pdr, "Infernal aurora boots", false).await;
    // println!("{}", pdr.get_resp().unwrap_or("No Text".to_owned()));
    //
    // get_item(&mut pdr, "racing", false).await;
    // println!("{}", pdr.get_resp().unwrap_or("No Text".to_owned()));
